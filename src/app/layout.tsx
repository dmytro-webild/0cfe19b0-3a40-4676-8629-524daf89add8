...
export const metadata: Metadata = {
  title: "Helion Era | Digital Growth Agency",  description: "Premium digital agency specializing in UI/UX design, web development, lead generation systems, and SEO strategy for brands ready to scale.",  keywords: "digital agency, UI/UX design, web development, lead generation, SEO strategy, digital growth",  metadataBase: new URL("https://helionera.com"),
  alternates: {
    canonical: "https://helionera.com"
  },
  openGraph: {
    title: "Helion Era | Digital Growth Agency",    description: "Strategic digital solutions for brands scaling fast. Design, development, and growth systems.",    type: "website",    siteName: "Helion Era",    images: [
      {
        url: "http://img.b2bpic.net/free-vector/abstract-business-card-pack-template_52683-45862.jpg",        alt: "Helion Era - Growth Systems for Brands"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",    title: "Helion Era | Digital Growth Agency",    description: "Strategic digital solutions for brands scaling fast.",    images: ["http://img.b2bpic.net/free-vector/abstract-business-card-pack-template_52683-45862.jpg"]
  }
};
